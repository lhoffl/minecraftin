...
if [[  "$difference" -gt "60" ]] || [[ $1 > 0 ]]; then
	...
	/usr/bin/python3 /home/ubuntu/sendMessage.py "Generating an updated world map"
	/usr/bin/python3 /home/ubuntu/overviewer.py --config=/home/ubuntu/overviewer_conf.py
	...
	/usr/bin/python3 /home/ubuntu/sendMessage.py "New world map available at http://lhoffl.com/minecraftin"
